...
class VoteContractTest {
    ...
    class CertifyVote {
        ...
        void testCompleteVoteFailed() throws Exception {
            ...
            testAccountStatus(ctx, ORG3_MSP, AUTHORIZED);
        }
        ...
        void testCompleteVotePassed() throws Exception {
            ...
            testAccountStatus(ctx, ORG3_MSP, UNAUTHORIZED);
    ...
    private void testAccountStatus(MockContext ctx, String targetMember, Status expected) {
