...
- [Asset Contract](#asset-contract)
  - [AddAsset](#AddAsset) (asset:AddAsset)
  - [AddLicenses](#AddLicenses) (asset:AddLicenses)
  - [RemoveLicenses](#RemoveLicenses) (asset:RemoveLicenses)
  - [UpdateEndDate](#UpdateEndDate) (asset:UpdateEndDate)
  - [GetAssets](#GetAssets) (asset:GetAssets)
  - [GetAsset](#GetAsset) (asset:GetAsset)
- [Order Contract](#order-contract)
  - [GetQuote](#GetQuote) (order:GetQuote)
  - [SendQuote](#SendQuote) (order:SendQuote)
  - [InitiateOrder](#InitiateOrder) (order:InitiateOrder)
  - [ApproveOrder](#ApproveOrder) (order:ApproveOrder)
  - [DenyOrder](#DenyOrder) (order:DenyOrder)
  - [GetLicensesToAllocateForOrder](#GetLicensesToAllocateForOrder) (order:GetLicensesToAllocateForOrder)
  - [GetAllocateRequestForOrder](#GetAllocateRequestForOrder) (order:GetAllocateRequestForOrder)
  - [SendLicenses](#SendLicenses) (order:SendLicenses)
  - [InitiateReturn](#InitiateReturn) (order:InitiateReturn)
  - [GetInitiatedReturnForOrder](#GetInitiatedReturnForOrder) (order:GetInitiatedReturnForOrder)
  - [DeallocateLicensesFromAccount](#DeallocateLicensesFromAccount) (order:DeallocateLicensesFromAccount)
  - [DeallocateLicensesFromSP](#DeallocateLicensesFromSP) (order:DeallocateLicensesFromSP)
  - [GetOrder](#GetOrder) (order:GetOrder)
  - [GetOrdersByAccount](#GetOrdersByAccount) (order:GetOrdersByAccount)
  - [GetOrdersByAccountAndAsset](#GetOrdersByAccountAndAsset) (order:GetOrdersByAccountAndAsset)
  - [GetOrdersByAsset](#GetOrdersByAsset) (order:GetOrdersByAsset)
  - [GetAvailableLicensesForOrder](#GetAvailableLicensesForOrder) (order:GetAvailableLicensesForOrder)
  - [GetExpiredOrders](#GetExpiredOrders) (order:GetExpiredOrders)
- [SWID Contract](#swid-contract)
  - [ReportSWID](#ReportSWID) (swid:ReportSWID)
  - [DeleteSWID](#DeleteSWID) (swid:DeleteSWID)
  - [GetSWID](#GetSWID) (swid:GetSWID)
  - [GetLicensesWithSWIDsForOrder](#GetLicensesWithSWIDsForOrder) (swid:GetLicensesWithSWIDsForOrder)
- [NGAC Contract](#ngac-contract)
  - [GetAllRoles](#GetAllRoles) (ngac:GetAllRoles)
  - [GetAllPrivileges](#GetAllPrivileges) (ngac:GetAllPrivileges)
