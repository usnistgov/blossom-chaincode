...
public class QuoteRequest {
    ...
    public QuoteRequest(String orderId, String account, String assetId, int amount, int duration) {
    ...
    public QuoteRequest(String account, String assetId, int amount, int duration) {
        this.account = account;
        this.assetId = assetId;
        this.amount = amount;
        this.duration = duration;
    ...
    public QuoteRequest(String orderId, String account, double price) {
        this.orderId = orderId;
        this.account = account;
        this.price = price;
    }
    ...
    private QuoteRequest(QuoteRequest req, boolean isRequest) {
        ...
        if (isRequest) {
            // a null order id means it is a new order
